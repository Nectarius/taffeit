        ...
        e.when = function (a, c) {
            ...
            function n(c, g, i) {
                ...
                return a.forEach(j, function (b, c) {
                    ...
                    if (q.chain[c] = {name: g, params: i, locals: e, reload: function () {
            ...
            function o(c) {
                ...
                q.name = q.name.substr(0, q.name.length - 1), b.$broadcast("routeSegmentChange", {index: c, segment: q.chain[c] || null})
            }
            ...
            var q = {name: "", $routeParams: a.copy(j), chain: [], startsWith: function (a) {
                var b = new RegExp("^" + a);
            ...
            return b.$on("$routeChangeSuccess", function (a, b) {
                ...
                if (c && c.segment) {
                    for (var e = c.segment, f = e.split("."), g = [], h = 0; h < f.length; h++) {
                        var i = p(h, f);
                        (r[h] != i.name || l(i)) && (q.chain[h] && q.chain[h].name == i.name && !l(i) ? r[h] = i.name : g.push({index: h, newSegment: i}))
                    }
                    var j = d.when();
